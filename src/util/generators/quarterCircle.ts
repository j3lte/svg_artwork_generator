...
export const generator: CreatorFunc = (drawer, block, options) => {
    ...
    const group = getGroup(drawer, 'qs', options?.optimize);
    ...
    const pathsFull = [
        ...
        `M${x + s},${y} L${x + s},${y + s} ${bigArc} ${x},${y} L${
            x + s
        },${y} z`, // TOP-RIGHT
        `M${x + s},${y + s} L${x},${y + s} ${bigArc} ${x + s},${y} L${
            x + s
        },${y} z`, // BOTTOM-RIGHT
        `M${x},${y + s} L${x},${y} ${bigArc} ${x + s},${y + s} L${x},${
            y + s
        } z`, // BOTTOM-LEFT
    ];

    const pathsHalf = [
        `M${x + h},${y} L${x + s},${y} ${bigArc} ${x},${y + s} L${x},${
            y + h
        } ${smallArc} ${x + h},${y} z`, // TL
        `M${x + s},${y + h} L${x + s},${y + s} ${bigArc} ${x},${y} L${
            x + h
        },${y} ${smallArc} ${x + s},${y + h} z`, // TR
        `M${x + h},${y + s} L${x},${y + s} ${bigArc} ${x + s},${y} L${x + s},${
            y + h
        } ${smallArc} ${x + h},${y + s} z`, // BR
        `M${x},${y + h} L${x},${y} ${bigArc} ${x + s},${y + s} L${x + h},${
            y + s
        } ${smallArc} ${x},${y + h} z`, // BL
    ];
